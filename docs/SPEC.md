...
| 模块 | 功能 | 说明 |
|------|------|------|
| 用户认证 | 注册、登录、退出 | 基础认证功能 |
| 成员管理 | 添加、编辑、删除、查看、列表 | 核心CRUD操作 |
| 族谱展示 | 树形图展示 | 单一视图，自上而下 |
...
| 功能 | 接口 | 说明 |
|------|------|------|
| 获取族谱树 | GET /genealogy/tree | 获取族谱树数据 |
| 获取成员后代 | GET /genealogy/{id}/descendants | 获取某成员的后代 |
| 获取成员祖先 | GET /genealogy/{id}/ancestors | 获取某成员的祖先 |
